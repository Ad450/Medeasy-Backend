...
{
    /// <inheritdoc />
    public partial class RefrestToken : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientProfilePictures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientProfilePictures_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Days_Practitioners_PractitionerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Kycs_Practitioners_PractitionerId",
                        column: x => x.PractitionerId,
                        principalTable: "Practitioners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PractitionerLocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PractitionerLocations_Practitioners_PractitionerId",
                        column: x => x.PractitionerId,
                        principalTable: "Practitioners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "PractitionerProfilePictures",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    PictureUrl = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PractitionerProfilePictures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PractitionerProfilePictures_Practitioners_PractitionerId",
                        column: x => x.PractitionerId,
                        principalTable: "Practitioners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientServices", x => new { x.PractitionerId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_PatientServices_Practitioners_PractitionerId",
                        column: x => x.PractitionerId,
                        principalTable: "Practitioners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Days_PractitionerId",
                table: "Days",
                column: "PractitionerId");

            migrationBuilder.CreateIndex(
                name: "IX_Kycs_PractitionerId",
                table: "Kycs",
                column: "PractitionerId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientProfilePictures_PatientId",
                table: "PatientProfilePictures",
                column: "PatientId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PractitionerLocations_PractitionerId",
                table: "PractitionerLocations",
                column: "PractitionerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PractitionerProfilePictures_PractitionerId",
                table: "PractitionerProfilePictures",
                column: "PractitionerId",
                unique: true);
        }
